...
if int(Method) == 2:
 ...
 # =========================================================================================   
    ...
    with open(PATH) as json_data:
        ...
        iter,eval,phi = app.SlabCP.aleig(a,b,eps,phi_guess,sigf,fmmid,delta,Max_it,[ng,totnfm,nmat,dim])
        sfpc,sf = app.SlabCP.scalarfluxpinc(nfmesh,delta,assembly,phi,sigf,fmmid,core,[dim,totnfm,nmat,ng,nx,nxx,npx,npc,na])
        app.SlabCP.plot_flux(nmat,nx,nxx,napc,delta,phi,sfpc,sf,[dim,totnfm,ng])
        interval = datetime.now()-start  
        print ('  Total time to solution      ........................     ', interval )  
        app.SlabCP.title2()
 #==========================================================================================
